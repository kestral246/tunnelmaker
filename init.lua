...
-- Version 2.0-beta-3 - 2019-01-23
--     Region functions - merge functions and fix bugs.
	...
	if minetest.check_player_privs(user, "tunneling") then
        local dig_patterns = {
            ...
            [31] = {                                                                                                            {{-1, 4},{0, 0, 0,  4,4,4, 4,  4, 4}}, {{ 0, 4},{0, 0, 0, 37,3,3,3,  3, 3}}, {{ 1, 4},{0, 0,37,  3,3,3,3,  3, 3}},
                    ...
                    {{-4, 1},{0,0,0,  4,4,4,4, 4,4}}, {{-3, 1},{0,0, 0, 4,4,4,4,  4, 4}}, {{-2, 1},{0, 0, 0,  4,4,4,4,  4, 4}}, {{-1, 1},{0,86, 8,  5,1,1, 1, 77, 2}}, {{ 0, 1},{0,86, 6, 12,1,1,1,  1, 2}}, {{ 1, 1},{0,86, 6, 14,1,1,1,  1, 2}}, {{ 2, 1},{0,0, 7, 1,1,1,21, 32, 4}}, {{ 3, 1},{0,0,37, 3,3,3,3, 3,30}},
		...
		-- Horizontal needed for angledstairs nodes, vertical should help combine functions.
		local dir = {}
		if cdir >= 24 then
			dir.horiz = (cdir - 24) * 2
			dir.vert = -1
